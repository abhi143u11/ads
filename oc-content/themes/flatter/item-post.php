	...
	<div class="container">
    	<div class="row">
        	<div class="col-md-12 col-sm-12 col-xs-12 page-title">
        		<h2><?php if($edit) { ?> <?php _e('Edit your listing', 'flatter'); ?> <?php } else { ?> <?php _e('Publish a listing', 'flatter'); ?> <?php } ?></h2>
                
				<?php if( osc_get_preference('position9_enable', 'flatter_theme') != '0') { ?>
                <div id="position-widget" class="<?php if( osc_get_preference('position9_hide', 'flatter_theme') != '0') {echo"hidden-xs";}?>">
