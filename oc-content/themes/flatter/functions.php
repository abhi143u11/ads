<?php
    ...
    define('FLATTER_THEME_VERSION', '1.3.7');
	...
	if( !osc_get_preference('terms_link', 'flatter_theme') ) {
        osc_set_preference('terms_link', __('Link to Terms and conditions page', 'flatter'), 'flatter_theme');
    }
	/* Privacy Policy Page */
	if( !osc_get_preference('privacy_link', 'flatter_theme') ) {
        osc_set_preference('privacy_link', __('Link to Privacy policy page', 'flatter'), 'flatter_theme');
    }
	/* Facebook Page */
	...
	if( !osc_get_preference('gplus_page', 'flatter_theme') ) {
        osc_set_preference('gplus_page', __('+DrizzledesignsInOfficial', 'flatter'), 'flatter_theme');
    }
	/* Pinterest Page */
	...
	if( !osc_get_preference('landing_pop', 'flatter_theme') ) {
        osc_set_preference('landing_pop', __('Sample content for popup', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('pop_heading', 'flatter_theme') ) {
        osc_set_preference('pop_heading', __('Welcome', 'flatter'), 'flatter_theme');
    }
	
	
	/* Widgets */
	if( !osc_get_preference('position1_content', 'flatter_theme') ) {
        osc_set_preference('position1_content', __('Widget Position #1', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position2_content', 'flatter_theme') ) {
        osc_set_preference('position2_content', __('Widget Position #2', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position3_content', 'flatter_theme') ) {
        osc_set_preference('position3_content', __('Widget Position #3', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position4_content', 'flatter_theme') ) {
        osc_set_preference('position4_content', __('Widget Position #4', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position5_content', 'flatter_theme') ) {
        osc_set_preference('position5_content', __('Widget Position #5', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position6_content', 'flatter_theme') ) {
        osc_set_preference('position6_content', __('Widget Position #6', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position7_content', 'flatter_theme') ) {
        osc_set_preference('position7_content', __('Widget Position #7', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position8_content', 'flatter_theme') ) {
        osc_set_preference('position8_content', __('Widget Position #8', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position9_content', 'flatter_theme') ) {
        osc_set_preference('position9_content', __('Widget Position #9', 'flatter'), 'flatter_theme');
    }
	if( !osc_get_preference('position10_content', 'flatter_theme') ) {
        osc_set_preference('position10_content', __('Widget Position #10', 'flatter'), 'flatter_theme');
    }
...
*/
    ...
    if( !function_exists('logo_header') ) {
        function logo_header() {
             ...
             $html = '<img class="img-responsive" border="0" alt="' . osc_page_title() . '" src="' . flatter_logo_url() . '" width="80">';
...
function editBtn() { ?>
 ...
 $('.current-theme .theme-description').append("<br/><br/><a href='<?php echo osc_admin_render_theme_url('oc-content/themes/flatter/admin/settings.php'); ?>' class='btn btn-green'><?php _e('Flatter Settings', 'flatter'); ?></a> <a class='btn btn-blue' target='_blank' href='http://www.drizzledesigns.in/forums'><?php _e('Help', 'flatter'); ?></a>"
);
 });
 </script>
 <?php }
