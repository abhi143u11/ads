            ...
            <div class="col-sm-9">
                ...
                <div id="content">
                    ...
                    <ul class="nav nav-tabs" role="tablist">
                      <li><a href="#editprofile" role="tab" data-toggle="tab"><?php _e('Account', 'flatter'); ?></a></li>
                      ...
                      <li class="active"><a href="#editpassword" role="tab" data-toggle="tab"><?php _e('Password', 'flatter'); ?></a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="edit-profile">
                            ...
                            <form action="<?php echo osc_base_url(true); ?>" class="form-horizontal" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php UserForm::multilanguage_info($locales, osc_user()); ?><?php //UserForm::info_textarea('s_info', osc_locale_code(), @$osc_user['locale'][osc_locale_code()]['s_info']); ?>
                      ...
                      <div class="tab-pane" id="deleteprofile">
                      	<div class="delete-profile">
                            ...
                            <a class="btn btn-danger" onclick="javascript:return confirm('<?php echo osc_esc_js(__('Are you sure you want to continue?', 'flatter')); ?>')" href="<?php echo osc_base_url().'?page=user&action=delete&id='.osc_logged_user_id().'&secret='.osc_user_field("s_secret"); ?>" class="opt_delete_account"><?php _e('Delete', 'flatter'); ?></a>
                        </div>
                      </div>
                    </div>
