	...
	<div class="container">
    	...
    	<div class="row">
        	...
        	<div class="col-md-9 col-sm-8">
                ...
                <div class="dd-widget position_4 <?php if( osc_get_preference('position4_hide', 'flatter_theme') != '0') {echo"hidden-xs";}?>">
                    <?php echo osc_get_preference('position4_content', 'flatter_theme', "UTF-8"); ?>
                </div>
                </div>
                <?php } ?>
                ...
                <div id="position_widget">
                <div class="dd-widget position_5 <?php if( osc_get_preference('position5_hide', 'flatter_theme') != '0') {echo"hidden-xs";}?>">
                    <?php echo osc_get_preference('position5_content', 'flatter_theme', "UTF-8"); ?>
                </div>
                </div>
                <?php } ?>
