    	...
    	<div class="row">
        	<div class="col-md-8 col-sm-7 col-xs-12 item-title">
				  <?php if( osc_get_preference('position7_enable', 'flatter_theme') != '0') { ?>
                    <div id="position_widget" class="<?php if( osc_get_preference('position7_hide', 'flatter_theme') != '0') {echo"hidden-xs";}?>">
                        <div class="dd-widget position_7">
                        <?php echo osc_get_preference('position7_content', 'flatter_theme', "UTF-8"); ?>
                        </div>
                    </div>
                  <?php } ?>
        	...
        	<div class="col-md-8 col-sm-7">
            	<div id="content">
                    ...
                    <div id="description">
                    	<div class="row">
                        	<div id="des" class="">
                                    <?php if (function_exists("check_in_button")) { ?>
				<?php check_in_button(); ?>
...
<?php osc_run_hook('item_detail', osc_item() ); ?></div><!-- Custom fields -->
                ...
                <div class="row item-bottom">
                    ...
                    <ul class="social-share">
                        <li class="facebook">
                           <a title="" data-toggle="tooltip" href="#" onclick="window.open('https://www.facebook.com/sharer/sharer.php?u='+encodeURIComponent('<?php echo osc_item_url(); ?>'), 'facebook-share-dialog', 'height=279, width=575'); return false;" data-original-title="<?php _e("Share on Facebook", 'flatter'); ?>"><i class="fa fa-facebook"></i>
                           </a>
                         </li>
                        <li class="twitter">
                        ...
                        <li class="googleplus">
                            <a title="" onclick="javascript:window.open(this.href, '','menubar=no,toolbar=no,height=600,width=600');return false;" href="https://plus.google.com/share?url=<?php echo osc_item_url(); ?>" data-toggle="tooltip" data-original-title="<?php _e("Share on Google+", 'flatter'); ?>">
                    ...
                    <div class="col-md-6">
                    	<?php if(osc_is_web_user_logged_in() && osc_logged_user_id()==osc_item_user_id()) { ?>
                        	...
                        	<a href="<?php echo osc_item_edit_url(); ?>"  rel="nofollow"><i class="fa fa-pencil"></i></a>
                            </div>
                        <?php } else { ?>
                ...
                <?php if( osc_get_preference('position8_enable', 'flatter_theme') != '0') { ?>
                    <div id="position_widget" class="<?php if( osc_get_preference('position8_hide', 'flatter_theme') != '0') {echo"hidden-xs";}?>">
