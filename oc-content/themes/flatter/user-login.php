	...
	<div class="container">
    	<div class="row">
            ...
            <form action="<?php echo osc_base_url(true); ?>" name="login" id="login" method="post" >
                    ...
                    <a class="pull-right" href="<?php echo osc_recover_user_password_url(); ?>" data-toggle="tooltip" data-placement="left" data-original-title="<?php _e("Forgot password?", 'flatter'); ?>"><i class="fa fa-question-circle fa-lg"></i></a></div>
                </form>
    		</div>
            </div>
        </div>
