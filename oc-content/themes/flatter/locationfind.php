    ...
    <div class="modal-dialog">
        <div class="modal-content">
			<div class="modal-header">
            	...
            	<h4 class="modal-title" id="myModalLabel"><i class="fa fa-map-marker"></i> <?php _e('Find by location', 'flatter'); ?></h4>
          	</div>
			...
			$.ajax({
				...
				success: function(data){
					...
					if(length > 0) {
						...
						$("#regionId").before('<input class="form-control" placeholder="<?php _e("Enter a region..."); ?>"type="text" name="region" id="region" />');
						$("#regionId").remove();
						
						$("#cityId").before('<input class="form-control" placeholder="<?php _e("Enter a city..."); ?>" type="text" name="city" id="city" />');
						$("#cityId").remove();
